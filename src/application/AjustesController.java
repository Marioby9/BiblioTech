...
public class AjustesController {
	...
	@FXML void clickAceptaAvisoMus(MouseEvent event) {
		...
		if (selectedFile != null) {
			menu.carpCanciones = selectedFile.getAbsolutePath();
			try {
				Ficheros.creaCarpetasMus(menu.carpCanciones);
				System.out.println("Carpetas creadas en: "+menu.carpCanciones);
				Conexion.updateTabla("AJUSTES", "CARP_MUSICA", menu.carpCanciones, "ID_USUARIO = "+Integer.toString(u1.getID_Usuario()));
			} catch (Exception e) {
				e.printStackTrace();
			}
