...
public class MenuController {
	...
	@FXML protected ImageView imgFondoMenu;
	...
	@FXML void clickBGuardarCambios(MouseEvent event) { //CAMBIA FOTO PERFIL, NOMBRE, CORREO, CONTRASE�A
		...
		if(!txtCambioPassword.getText().equals("")) { //CAMBIA CONTRASE�A
			...
			try {
				c1.updateTabla("USUARIO", "CONTRASE�A", nuevaCon, "ID = "+Integer.toString(u1.getID_Usuario()));
